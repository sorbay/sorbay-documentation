...
<img style="margin-left: 80px; width: 75%; border: 1px; border-style: solid; border-color: lightgray" src="../img/settings_general.png">
...
<img style="margin-left: 80px; width: 75%; border: 1px; border-style: solid; border-color: lightgray" src="../img/settings_leave-workspace.png">
...
confirmation pop-up dialog to delete the workspace and *irrevocably remove all its 
